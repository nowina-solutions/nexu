...
public class StoreResultController extends AbstractFeedbackUIOperationController implements Initializable {
	...
	protected void doInit(Object... params) {
		...
		Platform.runLater(() -> message.setText(StringEscapeUtils.unescapeJava(
				MessageFormat.format(ResourceBundle.getBundle("bundles/nexu").getString("store.configuration.header"),
						getApplicationName()))));
	}
}
