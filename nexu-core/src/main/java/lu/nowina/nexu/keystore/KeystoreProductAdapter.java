...
import lu.nowina.nexu.generic.HSMPkcs11SignatureToken;
		...
		private void initSignatureTokenConnection() {
			...
			try {
				...
				case JKS:
					...
					break;
				case PKCS11:
					proxied = new HSMPkcs11SignatureToken(configuredKeystore.getUrl(), callback, configuredKeystore.getSlotNumber());
					break;
				default:
